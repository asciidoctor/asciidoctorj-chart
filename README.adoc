...
ifdef::badges[]
image:https://github.com/asciidoctor/asciidoctorj-chart/actions/workflows/ci.yml/badge.svg?branch=main[Build Status (GitHub Workflow CI), link=https://github.com/asciidoctor/asciidoctorj-chart/actions/workflows/ci.yml]
endif::[]
