= AsciidoctorJ Chart: Asciidoctor
...
{uri-repo}[AsciidoctorJ Chart] is a convenient repackaging of Asciidoctor Chart for use with {uri-asciidoctorj}[AsciidoctorJ], which brings the Asciidoctor ecosystem to the JVM.

ifdef::badges[]
image:https://github.com/asciidoctor/asciidoctorj-chart/workflows/CI/badge.svg?branch=master[Build Status (GitHub Workflow CI), link=https://github.com/asciidoctor/asciidoctorj-chart/actions?query=workflow%3ACI+branch%3Amaster]
endif::[]
